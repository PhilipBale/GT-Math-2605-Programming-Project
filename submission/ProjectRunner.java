...
public class ProjectRunner {
    ...
    private enum Target {
        ...
        JACOBI("jacobi", "JacobiAndGaussSeidel iteration for a matrix", 2.21),
        GAUSS_SEIDEL("gauss_seidel", "Gauss seidel for a matrix", 2.22),
        DECODE("decode", "Decodes a given input binary stream", 2.3),
    ...
    public boolean handleInput() {
        ...
        switch (target) {
            ...
            case JACOBI:
                ...
                solution = inputMatrix.getAugment();
                inputMatrix = inputMatrix.removeAugment();
                augment = inputMatrix.getAugment();
                inputMatrix = inputMatrix.removeAugment();
                ...
                log("Jacobi result:");
                JacobiAndGaussSeidel.runJacobi(inputMatrix, augment, solution, tol);
                break;
            case GAUSS_SEIDEL:
                path = promptForAugmentedMatrixPath();
                inputMatrix = DotDatMatrixParser.parseMatrix(path);
